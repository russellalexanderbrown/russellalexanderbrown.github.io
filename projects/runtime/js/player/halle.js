(function (window) {
    ...
    window.opspark.makeHalle = function (spritesheet, particleManager, showHitZones) {
        ...
        p.jumpfly = function() {
            setAsset(_jumpfly);
            tweenHitForAction(_jumpfly.y + halle.y, null, 150, 150, 1150);
        };
        ...
        p.duck = function () {
            setAsset(_duck);
            tweenHitForAction(halle.y + halle.getBounds().height / 4, null, 100, 150, 1150);
        };
        ...
        p.shoot = function () {
            ...
            tweenHitForAction(_shootStart.y + halle.y + 20, halle.x - 30, 100, 150, 1150);
        };
